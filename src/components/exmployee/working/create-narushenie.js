    ...
    return (
        <div className="card">
            <div className="card-header">
                <h1>Койда бузарликлар руйхатини яратиш</h1>
            ...
            <br/>
            <div className="card-header">
                <h1>Койдалар руйхатини яратиш</h1>
                <div className="card-body">
            ...
            <br/>
            <div className="card-header">
                <h1>Койда бузилган булим руйхатини яратиш</h1>
                <div className="card-body">
            ...
            <br/>
            <div className="card-header">
                <h1>Цех ва булимлар руйхатини яратиш</h1>
                <div className="card-body">
